...
namespace Core.Common.Extensions
{
    ...
    {
        public static IDictionary<string, TElement> ToDictionaryCaseInsensitive<TSource, TElement>(this IEnumerable<TSource> source, Func<TSource, string> keySelector, Func<TSource, TElement> elementSelector)
        {
            return source.ToDictionary(m => keySelector.Invoke(m).ToUpperInvariant(), elementSelector);
        }
